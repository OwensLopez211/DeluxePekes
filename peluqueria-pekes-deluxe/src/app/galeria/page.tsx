...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-pink-50 relative overflow-x-hidden">
      {/* Background decorative elements - same as layout */}
      ...
      <div className="relative z-10 pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 mb-12">
          <div className={`text-center max-w-4xl mx-auto transform transition-all duration-1000 ${isMounted && isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
